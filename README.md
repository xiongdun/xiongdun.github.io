...
###[View Live Hux Blog &rarr;](https://xiongdun.top)

![](http://xiongdun.top/img/blog-desktop.jpg)
...
```
$ git clone https://github.com/xiongdun/xiongdun.github.io.git
```

**[View Boilerplate Here &rarr;](http://xiongdun.top/huxblog-boilerplate/)**
...
<img src="http://xiongdun.top/img/blog-md-navbar.gif" width="320" />
...
```
# 站点设置
title: Bruce Blog             # title of your website
SEOTitle: Bruce Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: xiongdun     # modify this account to yours
weibo_username: xiongdun      # the footer woule be auto-updated.
...
![](http://xiongdun.top/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://xiongdun.top/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“Bruce Blog”** but I want the title shows in search engine is **“熊墩的博客 | Bruce Blog”** which is multi-language.
